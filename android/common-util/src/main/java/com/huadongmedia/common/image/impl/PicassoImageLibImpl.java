package com.huadongmedia.common.image.impl;
...
import com.huadongmedia.common.image.CommonImageLoader;
import com.huadongmedia.common.image.listener.ImageLibInterface;
import com.huadongmedia.common.image.listener.ImageLoaderListener;
import com.huadongmedia.common.util.FileUtil;
import com.huadongmedia.common.util.StringUtil;
import com.huadongmedia.common.util.Utils;
...
public class PicassoImageLibImpl implements ImageLibInterface {
	...
	public void loadImage(String url, int resId, ImageView view, int loadingResId, int errorResId, boolean cache,
		...
		if (!StringUtil.isEmpty(url) || resId != 0) {
